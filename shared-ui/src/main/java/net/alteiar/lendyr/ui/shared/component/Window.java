...
public class Window extends Actor {
  ...
  private Window(AssetManager assetManager) {
    background = assetManager.get("fantasy-gui/bg.png");// assetManager.get("black-crusader-ui/BlackCrusaderUI_el_31.png", Texture.class);
  ...
  public void draw(Batch batch, float parentAlpha) {
    batch.draw(background, getX(), getY(), 0, 0, (int) getWidth(), (int) getHeight());
